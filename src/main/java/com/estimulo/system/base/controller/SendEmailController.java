...
public class SendEmailController extends AbstractController {
   ...
   public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) {
      ...
      String savePath = "C:\\dev\\ibatis\\pro_3rd\\3rd_Logistics\\src\\main\\webapp\\resources\\iReportForm";
      
      String host = "smtp.gmail.com";
      final String user = "jmkim3602@gmail.com";
      final String password = "Vongola159!!";

      String to = "jmkim3602@naver.com";
